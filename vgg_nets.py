...
class Vgg16(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False):
        ...
        vgg_pretrained_features = models.vgg16(
            pretrained=True, progress=show_progress).features
...
class Vgg16Experimental(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False):
        ...
        vgg_pretrained_features = models.vgg16(
            pretrained=True, progress=show_progress).features
        self.layer_names = ['relu1_1', 'relu2_1', 'relu2_2',
                            'relu3_1', 'relu3_2', 'relu4_1', 'relu4_3', 'relu5_1']
    ...
    def forward(self, x):
        ...
        vgg_outputs = namedtuple("VggOutputs", self.layer_names)
        out = vgg_outputs(relu1_1, relu2_1, relu2_2, relu3_1,
...
class Vgg19(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, show_progress=False, use_relu=True):
        ...
        if use_relu:  # use relu or as in original paper conv layers
            self.layer_names = ['relu1_1', 'relu2_1',
                                'relu3_1', 'relu4_1', 'conv4_2', 'relu5_1']
            self.offset = 1
        else:
            self.layer_names = ['conv1_1', 'conv2_1',
    ...
    def forward(self, x):
        ...
        layer5_1 = x
        vgg_outputs = namedtuple("VggOutputs", self.layer_names)
        out = vgg_outputs(layer1_1, layer2_1, layer3_1,
                          layer4_1, conv4_2, layer5_1)
        return out
